const dataText = {
  EN: {
    ...
    Team: {
      ...
      text1:
        'As students of RS-School, our team actively worked on this project and applied the knowledge gained. Each team member made an invaluable contribution and experience to the creation of this site. We tried to use various technologies and created a modern design.',
      text2:
        'We tried to collect all the most interesting information about Belarusian photographers and their work. Described all the most important dates of their biography.',
    },
    Photographers: {
  ...
  RU: {
    ...
    Team: {
      ...
      text1:
        'Будучи студентами RS-School, наша команда активно работала над этим проектом и применяла полученные знания. Каждый член команды внес свой неоценимый вклад и опыт в создании этой площадки. Мы старались использовать различные технологии  и создали современный дизайн.',
      text2:
        'Мы постарались собрать всю самую интересную информацию о белорусских фотографах и их работах. Описали все самые важные даты их биографии.',
    },
    Photographers: {
  ...
  BY: {
    ...
    Team: {
      ...
      text1:
        'Будучы студэнтамі RS-School, наша каманда актыўна працавала над гэтым праектам і ўжывала атрыманыя веды. Кожны член каманды унёс свой неацэнны ўклад і вопыт у стварэнне гэтай пляцоўкі. Мы імкнуліся выкарыстаць розныя тэхналогіі і стварылі сучасны дызайн.',
      text2:
        'Мы пастараліся сабраць усю самую цікавую інфармацыю пра беларускіх фатографаў і іх працах. Апісалі ўсе самыя важныя даты іх біяграфіі.',
    },
    Photographers: {
